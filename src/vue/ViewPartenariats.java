...
public class ViewPartenariats extends JPanel implements MouseListener {
	/*
	 * 
	 */
	private static final long serialVersionUID = 1L;

	public ViewPartenariats() {
		...
		JLabel txtTitre = new JLabel("PARTENARIATS"); // initialise la zone de
														// titre et la
														// positionne à Gauche
		...
		String s1 = "Partenariats\n\n";
		String s2 = "Vous désirez utiliser notre logiciel dans le cadre de votre entreprise ? \n"
				+ "Contactez-nous par mail : partners@jdvelh.com";
