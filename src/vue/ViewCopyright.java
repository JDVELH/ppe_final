...
/*
 *  Classe des copyrights
 */
public class ViewCopyright extends JPanel implements MouseListener {

	private static final long serialVersionUID = 1L;

	public ViewCopyright() {
		Color couleur = new Color(125, 0, 255, 255);
		Color couleur2 = new Color(125, 0, 125, 255);
		Border bord = BorderFactory.createLineBorder(couleur, 2);
		 ...
		 */
		String imgUrl = "C:/Users/greta/eclipse-workspace/PPE_V2/src/Images/";
		...
		JLabel txtTitre = new JLabel("COPYRIGHT"); // initialise la zone de
													// titre et la positionne à
													// Gauche
		...
		String s1 = "Copyright\n\n";
		String s2 = "Ici s'afficheront les informations de copyright. Elles comprennent : \n"
				+ ". les licences des logiciels, languages, bases de données utilisées,\n"
				+ ". le type de licence auquel est soumis le logiciel : ex. Creative Commons, etc,\n"
				+ ". les dates d'application de/s licence/s, \n" + ". etc.";
