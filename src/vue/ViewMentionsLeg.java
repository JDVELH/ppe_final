...
public class ViewMentionsLeg extends JPanel implements MouseListener {

	private static final long serialVersionUID = 1L;

	public ViewMentionsLeg() {
		...
		JLabel txtTitre = new JLabel("MENTIONS LEGALES"); // initialise la zone
															// de titre et la
															// positionne à
															// Gauche
		...
		String s1 = "Mentions légales\n\n";
		String s2 = "Ici s'afficheront les mentions légales. Elles comprennent : \n"
