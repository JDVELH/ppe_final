...
public class ViewTutoriel extends JPanel implements MouseListener {
	/*
	 * 
	 */
	...
	public ViewTutoriel() {
		...
		JLabel txtTitre = new JLabel("TUTORIEL"); // initialise la zone de titre
		...
		String s1 = "Tutu tutu tutu tuto tututo tututo !\n\n";
		String s2 = "Trouver le moyen de créer des chapitres liés par des ancres, sans utiliser Html \n"
				+ ". en utilisant des boutons ? \n"
				+ ". des JLabel clicquables ?";
